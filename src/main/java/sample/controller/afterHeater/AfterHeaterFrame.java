package main.java.sample.controller.afterHeater;
...
public class AfterHeaterFrame extends Application implements BaseFrame {
    ...
    FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/main/java/sample/view/afterHeater/afterHeater.fxml"));
    Parent root1;
    Stage stage;
