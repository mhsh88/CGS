...
public class Gas extends BaseGas {
    ...
    public double getHHVd(){
        Double[] massFraction = MathCalculation.matrixDevide(MathCalculation.multiply(this.getComponent(), dencity) , MathCalculation.dotProduct(this.getComponent(), dencity));
